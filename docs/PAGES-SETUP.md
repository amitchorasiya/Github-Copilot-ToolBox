...
**Install links:** **`index.html`** promotes both the [**VS Code Marketplace**](https://marketplace.visualstudio.com/items?itemName=amitchorasiya.github-copilot-toolbox) (`vscode:` / browser) and the [**JetBrains Plugin Repository**](https://plugins.jetbrains.com/search?search=Github+Copilot+ToolBox) (`com.amitchorasiya.github.copilot.toolbox`).
